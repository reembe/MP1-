...
public class Person2 {
   ...
   public void date() {
       System.out.println("Nice to meet you, " + user.getName() + ". My name is Bartholemew, but people call me " + nickname + "! Do you want to go on a museum date (1) or a restaurant date (2)?");
       //        redFlags++;
