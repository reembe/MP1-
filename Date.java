   ...
   public void dwC() {
        ...
        if (choice.equals("1")) {
            ...
            if (needs.equalsIgnoreCase("no")) {
                ...
                pa.pauseTime(3000);
                System.out.println("Yeah, we are not getting that. Let's go pay now.");
                dateChris.addRedFlag(1);
            }
            ...
            if (weight > 100) {
                ...
                pa.pauseTime(2000);
                System.out.println("Bye fatty, I'll text you my gym location before I block you.");
                dateChris.addRedFlag(1);
            } else {
                c.clearScreen();
            ...
            System.out.println("Let's go stand on line for the biggest roller coaster!\nGee this line is pretty long. Im going to step away for a sec if you don't mind.");
            pa.pauseTime(1000);
            ...
            pa.pauseTime(1000);
            System.out.println("*He sees you staring at the burger*");
            pa.pauseTime(1000);
            System.out.println("LOL girl stop staring ur burning holes in my food");
            dateChris.addRedFlag(3);
            pa.pauseTime(1000);
            ...
            if (callOut.equalsIgnoreCase("yes")) {
        ...
        dGertrude.introduce();
        Scanner s = new Scanner(System.in);
        System.out.println("Hey where do you want to go eat? Applebee's or Olive Garden, I'm a little short on money.");
        dGertrude.addRedFlag(1);
        pa.pauseTime(1000);
